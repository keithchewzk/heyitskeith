export const aboutMeParaOne =
  "I discovered my passion for programming in university, where a module sparked my interest. Since then, I’ve pursued a variety of areas through MSD's Emerging Talent Rotation Programme, including full-stack development, AI engineering, and cloud architecture. ";
