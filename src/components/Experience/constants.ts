export const jobs = [
  ...
  },
  {
    ...
    company: "MSD",
    description:
      "My first rotation was with the Cloud Business Office as a Cloud Engineer. I developed cloud automation tools that significantly enhanced decision-making within the team. I engineered solutions for cloud products that improved visibility into cloud costs, enabling more informed and strategic actions to optimize resource usage. My contributions helped streamline cloud operations and reduce unnecessary expenditures, driving overall efficiency and cost-effectiveness in managing the company's cloud infrastructure.",
