export const JOBS = [
  {
    ...
    company: "NUS",
    description:
      "I pursued a Bachelor's degree in Computational Biology, studying a mix of biology and computer science modules. Along the way, I found that I enjoyed building software more than doing scientific research, which led me to where I am today in the tech industry.",
