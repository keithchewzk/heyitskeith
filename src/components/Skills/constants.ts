export const SKILLS = [
  ...
  { skill: "CSS", categories: ["languages"] },
  { skill: "JavaScript", categories: ["languages"] },
  { skill: "NLP", categories: ["concepts"] },
  ...
  { skill: "NextJS", categories: ["frameworks"] },
  { skill: "ReactNative", categories: ["frameworks"] },
];
